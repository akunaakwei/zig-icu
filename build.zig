...
pub fn build(b: *std.Build) void {
    ...
    const data_dep = switch (target.result.cpu.arch.endian()) {
        .big => b.dependency("icudtb", .{}),
        .little => b.dependency("icudtl", .{}),
    };
    const data_name = b.fmt("icudt76{s}.dat", .{data_char});
    ...
    uc.linkLibCpp();
    uc.step.dependOn(&genccode_run.step);
